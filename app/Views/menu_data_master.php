    ...
    <div class="row mt-4">
        ...
        <div class="col-md-4">
            <a class="text-decoration-none" href="<?= base_url() ?>/corousel_desktop">
                <div class="card mb-3 shadow" style="border: 1px solid #1762A5;">
                    <h5 class="card-header" style="background-color: #1762A5; color: #fff;">Master Suplier</h5>
                    <div class="card-body text-dark">
        ...
        <div class="col-md-4">
            <a class="text-decoration-none" href="<?= base_url() ?>/corousel_desktop">
                <div class="card mb-3 shadow" style="border: 1px solid #1762A5;">
                    <h5 class="card-header" style="background-color: #1762A5; color: #fff;">Master Pelanggan</h5>
                    <div class="card-body text-dark">
