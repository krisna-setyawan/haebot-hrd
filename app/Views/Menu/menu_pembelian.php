...
<main class="p-md-3 p-2">
    ...
    <div class="row mt-4">
        <div class="col-md-4">
            <a class="text-decoration-none" href="<?= base_url() ?>/pembelian">
                <div class="card mb-3 shadow" style="border: 1px solid #1762A5;">
                    ...
                    <div class="card-body text-secondary">
                        <i class="fa-3x fa-solid fa-boxes-packing"></i>
                    </div>
                </div>
            </a>
        </div>
        <div class="col-md-4">
            <a class="text-decoration-none" href="<?= base_url() ?>/pembelian">
                <div class="card mb-3 shadow" style="border: 1px solid #1762A5;">
                    <h5 class="card-header" style="background-color: #1762A5; color: #fff;">Penerimaan Pesanan</h5>
                    <div class="card-body text-secondary">
                        <i class="fa-3x fa-solid fa-people-carry-box"></i>
                    </div>
                </div>
            </a>
        </div>
